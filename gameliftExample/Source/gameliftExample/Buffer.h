 ...
 * 
 */
class GAMELIFTEXAMPLE_API Buffer
{
public:
	Buffer() : mBRegionPointer(nullptr), mARegionSize(0), mBRegionSize(0), mCapacity(1024)
	{
	}

	Buffer(size_t capacity) : mBRegionPointer(nullptr), mARegionSize(0), mBRegionSize(0), mCapacity(capacity)
	{
